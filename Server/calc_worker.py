...
from data_sharing import salvar_resultado_compartilhado, set_last_calc, increment_calc_requests
...
print(f"calc_worker conectado em {REDIS_HOST}:{REDIS_PORT}.")
...
try:
    for message in pubsub.listen():
        ...
        try:
            ...
            print(f"calc_worker recebido: {data}")
            resultado = processar_calculo(data)
            set_last_calc(r, resultado)
            increment_calc_requests(r)
